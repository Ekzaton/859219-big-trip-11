...
export const createTripEventsEditTemplate = (eventsItem) => {
  ...
  const transfersMarkup = createTransfersMarkup();
  const activitiesMarkup = createActivitiesMarkup();
